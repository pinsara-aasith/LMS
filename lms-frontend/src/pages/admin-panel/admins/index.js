...
export function deleteAdmin(adminId) {
  return axios.delete(`${BACKEND_URL}/api/admins/${adminId}`)
}
...
const useAdmins = (data, page, rowsPerPage, search) => {
  return useMemo(
    () => {
...
const Page = () => {
  ...
  const admins = useAdmins(data, page, rowsPerPage, search);
  ...
  async function retrieveAndRefreshData() {
    ...
    try {
      ...
      console.log("Admins were fetched from the database", admins)
              ...
              <div>
                ...
                >
                  <Button
                    ...
                    variant="contained"
                    href={'/admin-panel/admins/create'}
